...
// End Cross Module References
	...
	struct Z_Construct_UClass_ABloque_Padre_Statics
	{
		...
		static const UE4CodeGen_Private::FBytePropertyParams NewProp_TipoBloque_Underlying;
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UClass_ABloque_Padre_Statics::NewProp_TipoBloque_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ABloque_Padre_Statics::NewProp_TipoBloque_MetaData[] = {
		{ "Category", "Bloque_Padre" },
		{ "Comment", "// Variable para almacenar el tipo\n" },
		{ "ModuleRelativePath", "Bloque_Padre.h" },
		{ "ToolTip", "Variable para almacenar el tipo" },
	};
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_ABloque_Padre_Statics::NewProp_TipoBloque = { "TipoBloque", nullptr, (EPropertyFlags)0x0020080000020015, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ABloque_Padre, TipoBloque), Z_Construct_UEnum_Bomberman_012025_ETipoBloque, METADATA_PARAMS(Z_Construct_UClass_ABloque_Padre_Statics::NewProp_TipoBloque_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ABloque_Padre_Statics::NewProp_TipoBloque_MetaData)) };
